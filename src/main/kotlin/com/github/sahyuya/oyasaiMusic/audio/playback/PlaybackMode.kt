 ...
 * - [DEFAULT] = 「デフォルト再生」: Adventure APIの `Sound.Emitter.self()` 内部的には
 *   `ClientboundSoundEntityPacket` を使用）で、音源をプレイヤー自身に追従させる。
 ...
 *   楽曲詳細GUIで、リスナーごとにどちらで再生するか個別に選択・保存できる想定 （[com.oyasai.music.db.PlaybackPreferenceRepository]）。
 */
